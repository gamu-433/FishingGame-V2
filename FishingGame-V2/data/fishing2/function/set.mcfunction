...
scoreboard objectives modify fish_timeattack2 displayname [{"text":"～"},{"text":"Fishing","color":"red","bold":true},{"text":"チャレンジ","color":"aqua","bold":true},{"text":"結果","color":"yellow"},{"text":"～"}]
...
scoreboard objectives add fish_rodnow2 dummy
scoreboard objectives add fish_rodnow3 dummy
