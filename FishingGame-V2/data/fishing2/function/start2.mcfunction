...
title @a[tag=1_1] actionbar [{"text":"Fishing","color":"red","bold":true},{"text":"5分釣りチャレンジ","color":"aqua","bold":true},{"text":" ～スタート～","color":"light_purple"}]
tellraw @a[tag=1_1] [{"text":"Fishing","color":"red","bold":true},{"text":"5分釣りチャレンジ","color":"aqua","bold":true},{"text":" ～スタート～","color":"light_purple"}]
...
scoreboard players reset @a[tag=1_1] fish_timeattack
scoreboard players set @a[tag=1_1] fish_timeattack 0
